            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <?php if ($materi->unggah_materi == null) : ?>
                                <form action="<?= base_url(); ?>/materi/edit_" method="post">
                                    <input type="hidden" name="id_materi" value="<?= $materi->id_materi; ?>">
                                    <div class="form-group">
                                        <label for="nama_materi">Nama Materi</label>
                                        <input type="text" class="form-control" name="nama_materi" id="nama_materi" value="<?= $materi->nama_materi; ?>" autocomplete="off" required>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="mapel" id="mapel">
                                            ...
                                            <?php foreach ($gurumapel as $m) : ?>
                                                <option value="<?= $m->mapel_id; ?>" <?= ($materi->mapel == $m->mapel_id) ? 'selected' : ''; ?>><?= $m->mapel; ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="kelas" id="kelas">
                                            ...
                                            <?php foreach ($gurukelas as $k) : ?>
                                                <option value="<?= $k->kelas_id; ?>" <?= ($materi->kelas == $k->kelas_id) ? 'selected' : ''; ?>><?= $k->kelas; ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <label for="">Materi</label>
                                        <textarea class="summernote" name="bikin_manual"><?= $materi->bikin_manual; ?></textarea>
                                    </div>
                                    <button type="submit" class="btn btn-primary float-right mt-3">Update Data</button>
                                </form>
                            <?php else : ?>
                                <form action="<?= base_url(); ?>/materi/editupload_" method="post" enctype="multipart/form-data">
                                    <input type="hidden" name="id_materi" value="<?= $materi->id_materi; ?>">
                                    <div class="form-group">
                                        <label for="nama_materi">Nama Materi</label>
                                        <input type="text" class="form-control" name="nama_materi" id="nama_materi" value="<?= $materi->nama_materi; ?>" autocomplete="off" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="summernote" name="catatan"><?= $materi->catatan; ?></textarea>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label for="">File</label><br>
                                                <label for="">Current file : <?= $materi->unggah_materi; ?></label>
                                                <div class="custom-file">
                                                    <input type="file" class="custom-file-input unggah_materi" id="unggah_materi" name="unggah_materi">
