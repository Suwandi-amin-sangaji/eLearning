            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<?= base_url(); ?>/siswa/materi">Materi</a></li>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-3 shadow p-3 ml-2 bg-white rounded">
                                            <div class="materi-body p-1">
                                                ...
                                                <a href="<?= base_url(); ?>/download/downloadmateri/<?= $materi->id_materi; ?>" class="btn btn-primary"><i class="fas fa-download"></i> Download</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
